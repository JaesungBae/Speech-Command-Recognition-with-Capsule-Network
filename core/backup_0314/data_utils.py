...
'''
def load_random_noisy_data(data_path, is_training, mode):
    featPath = os.path.join(saved_path,is_training,mode) #/TRAIN/fbank
    labelPath = os.path.join(saved_path,is_training,'label')#/TRAIN/label
